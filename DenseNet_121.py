...
def DenseNet_121(input_shape, n_classes, filters = 32):
...
def DenseNet_121_Tiny(input_shape, n_classes, filters = 32):
...
model = DenseNet_121_Tiny(input_shape=(6000, 1, 1), n_classes=2, filters = 32)
model.summary()